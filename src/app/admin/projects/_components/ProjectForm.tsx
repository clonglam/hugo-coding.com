...
import SelectCategoriesField from "@/components/SelectCategoriesField"
...
function ProjectForm({ project, categories }: ProjectFormProps) {
  ...
  return (
    <div>
      <Form {...form}>
        <form id="project-form" className="gap-x-5 flex" onSubmit={onSubmit}>
          ...
          <div>
            ...
            <div className="flex flex-col gap-y-5">
              ...
              <FormItem>
                ...
                <UncontrolledFormMessage
                  message={errors.demoWebsite?.message}
                />
              </FormItem>
            </div>
          </div>
